 ...
 * @param  array<string, mixed>  $fieldOverrides
 */
function seedMenusSetting(array $fieldOverrides = []): Setting
{
    return Setting::query()->updateOrCreate(
        ['type' => 'menus', 'sub_type' => null],
        [
 ...
 * @param  array<string, mixed>  $fieldOverrides
 */
function seedSmtpSetting(array $fieldOverrides = []): Setting
{
    return Setting::query()->updateOrCreate(
        ['type' => 'smtp', 'sub_type' => null],
        [
            'title' => 'SMTP Settings',
            'fields' => array_merge([
                'mail_mailer' => 'log',
