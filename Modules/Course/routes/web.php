...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'role:admin', 'menu.enabled:courses'])->prefix('dashboard')->group(function () {
    // Course Categories
...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'role:instructor,admin', 'menu.enabled:courses'])->prefix('dashboard')->group(function () {
    // Courses
