...
Route::middleware(['auth', 'role:admin', 'menu.enabled:exams'])->prefix('dashboard')->group(function () {
...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'role:instructor,admin', 'menu.enabled:exams'])->prefix('dashboard')->group(function () {
