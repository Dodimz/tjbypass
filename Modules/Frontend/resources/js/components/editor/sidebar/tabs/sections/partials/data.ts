...
import Services1 from '@/frontend/page-jsx/home-1/services';
...
import FinalCtaBanner from '@/frontend/page-jsx/sections/final-cta-banner';
import TrustSignals from '@/frontend/page-jsx/sections/trust-signals';
      ...
      elements: [
         {
            ...
            name: 'Services 1',
            component: Services1(),
            preview: '/assets/sections/home-1/services.png',
         },
      ],
   },
    {
