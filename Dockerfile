...
CMD ["sh", "-c", "chmod -R 775 storage bootstrap/cache && php artisan config:clear && php artisan migrate --force || true && php artisan serve --host=0.0.0.0 --port=${PORT:-3000} --no-reload"]