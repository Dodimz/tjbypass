...
const getDashboardRoutes = (page: SharedData): DashboardRoute[] => {
   const { translate, pluginStatuses, hiddenMenus } = page;
         ...
         pages: [
               ...
               children: [
                  {
                     ...
                     slug: routeLastSegment(services.index.url()),
                     path: services.index.url(),
                     access: ['admin', 'collaborative', 'administrative'],
                  },
                  {
                     name: 'Create Service',
                     slug: routeLastSegment(services.create.url()),
                     path: services.create.url(),
                     access: ['admin', 'collaborative', 'administrative'],
                  },
                  {
                     name: 'Orders',
                     slug: routeLastSegment(serviceOrders.index.url()),
                     path: serviceOrders.index.url(),
                     access: [
                        'admin',
                        'instructor',
                        'collaborative',
            ...
            },
            {
               ...
               children: [
                  ...
                  {
                     name: 'Menus',
                     slug: routeLastSegment(menus.index.url()),
                     path: menus.index.url(),
                     access: ['admin'],
                  },
               ],
            },
   ...
   return allRoutes.map((group) => ({
      ...group,
      pages: group.pages.filter((item) => !hiddenMenus?.includes(item.slug)),
   }));
};
