...
Route::prefix('dashboard')->group(function () {
    ...
    Route::resource('newsletters', NewsletterController::class)->only(['index', 'store', 'update', 'destroy'])
        ->middleware('menu.enabled:newsletters');
    Route::post('newsletters/send', [NewsletterController::class, 'newsletter_send'])->name('newsletters.send')->middleware(['smtpConfig', 'menu.enabled:newsletters']);

    // job circulars
    Route::middleware('menu.enabled:job-circulars')->group(function () {
    ...
    Route::controller(SettingController::class)->prefix('settings')->group(function () {
        ...
        Route::get('menus', 'menus')->name('menus.index');
        Route::post('menus/{id}', 'menus_update')->name('menus.update');
