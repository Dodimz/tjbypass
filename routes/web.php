...
Route::middleware(['web'])->group(function () {
    ...
    Route::get('services', [ServiceController::class, 'guest_index'])->name('services.guest.index');
    Route::get('services/{service:uuid}', [ServiceController::class, 'guest_show'])->name('services.guest.show');
